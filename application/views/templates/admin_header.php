    ...
    <nav class="top-bar" data-topbar>
        ...
        <section class="top-bar-section">
            ...
            <li class="has-dropdown">
                ...
                <a href="#">Blogs</a>
                <ul class="dropdown">
                    <li><a href="<?php echo base_url('admin/form/' . CONTENT_BLOG_STR); ?>">Add Blog</a></li>
                    <li><a href="<?php echo base_url('admin/main/' . CONTENT_BLOG_STR); ?>">Manage Blogs</a></li>
                </ul>
            </li>
            <!-- </li><li class="has-dropdown">
                <a href="#">Articles</a>
            ...
            <li class="has-dropdown">
                ...
                <ul class="dropdown">
                    ...
                    <li><a href="<?php echo base_url('pages/qa'); ?>">Q & A</a></li>

		...
		<aside class="small-2 columns">
			<div class="sidebar">
				<ul class="side-nav">
					...
					<li <?php echo $active == 'add' ? 'class="active"' : ''; ?>><a href="<?php echo base_url('admin/form/' . CONTENT_BLOG_STR); ?>">+ Add Blog</a></li>
					<li <?php echo $active == 'main' ? 'class="active"' : ''; ?>><a href="<?php echo base_url('admin/main/' . CONTENT_BLOG_STR); ?>">All Blogs</a></li>
				</ul>
			</div>
		</aside>
		<?php
		...
		<aside class="small-2 columns">
			<div class="sidebar">
				<ul class="side-nav">
					...
					<li <?php echo $active == 'contact' ? 'class="active"' : ''; ?>><a href="<?php echo base_url('pages/contact'); ?>">Contact Us</a></li>
					<li <?php echo $active == 'qa' ? 'class="active"' : ''; ?>><a href="<?php echo base_url('pages/qa'); ?>">Q&A</a></li>
